...
Rails.application.config.content_security_policy do |policy|
  ...
  policy.img_src     :self, :https, :data, ENV.fetch('UMEDIA_NAILER_CDN_URI', 'https://example.cloudfront.net'), 'www.lib.umn.edu', 'cfvod.kaltura.com', 'http://www.google-analytics.com', 'd1rxd8nozvj6aj.cloudfront.net', 'www.googletagmanager.com'
