...
Rails.application.config.content_security_policy do |policy|
  ...
  policy.img_src     :self, :https, :data, ENV['UMEDIA_NAILER_CDN_URI'], 'www.lib.umn.edu', 'http://cdm16022.contentdm.oclc.org', 'cdm16022.contentdm.oclc.org', 'cfvod.kaltura.com', 'http://www.google-analytics.com', 'd1rxd8nozvj6aj.cloudfront.net', 'www.googletagmanager.com'
  ...
  policy.style_src   :self, :https, :unsafe_inline, :blob, 'fonts.googleapis.com'
