  ...
  def to_h
    {
      ...
      'https://creativecommons.org/publicdomain/mark/1.0' => { images: ['cc_icon_white_x2.png', 'pd_white_x2.png'], text: 'This work has been identified as being free of known restrictions under copyright law, including all related and neighboring rights. You can copy, modify, distribute and perform the work, even for commercial purposes, all without asking permission. For mor details about this license, https://creativecommons.org/publicdomain/mark/1.0.' }
    }
  end
