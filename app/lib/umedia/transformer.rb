  ...
  class Transformer
    ...
    def self.field_mappings
      ...
      # Geographic Details
        ...
        {dest_path: 'state', origin_path: 'state', formatters: [CDMDEXER::SplitFormatter, CDMDEXER::StripFormatter]},
        {dest_path: 'country', origin_path: 'countr', formatters: [CDMDEXER::SplitFormatter, CDMDEXER::StripFormatter]},
        {dest_path: 'region', origin_path: 'region', formatters: [CDMDEXER::SplitFormatter, CDMDEXER::StripFormatter]},
        {dest_path: 'continent', origin_path: 'contin', formatters: [CDMDEXER::SplitFormatter, CDMDEXER::StripFormatter]},
        {dest_path: 'geonames', origin_path: 'geonam', formatters: [CDMDEXER::SplitFormatter, CDMDEXER::StripFormatter]},
