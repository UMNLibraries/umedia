...
class HomeTest < ActiveSupport::TestCase
  ...
  describe 'when a search with no query has been submitted (the default search)' do
    ...
    it 'sorts z to a' do
      ...
      sleep 1
      find(:xpath, '//*[@id="main"]/div[7]/div[1]/div/div/a').text.must_equal('Warehouse work')
    end
    it 'sorts creator a to z' do
      ...
      sleep 1
      find(:xpath, '//*[@id="main"]/div[7]/div[1]/div/div/a').text.must_equal('125th Anniversary Celebration, 1978. (Box 1, Folder 20)')
    end
    ...
    it 'sorts by date, oldest first' do
      ...
      sleep 1
      find(:xpath, '//*[@id="main"]/div[7]/div[1]/div/div/a').text.must_equal('15th Century, Afghanistan and Pakistan')
    end
