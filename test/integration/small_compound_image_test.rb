...
class SmallCompoundTest < ActiveSupport::TestCase
  ...
  it 'loads the OSD viewer and a clickable list of sidebar child pages' do
    ...
    _(find(:xpath, '//*[@id="metadata-area"]/div[85]/div').text).must_equal '1853 1978 1905 125TH ANNIVERSARY YMCAS SERI COMMUNITY 1978 Seventy-three years of service YMCA of MONTCLAIR'
  end
  it 'sidebar pages are searchable' do
    ...
    sleep 2
    _(find(:xpath, '//*[@id="sidebar-p16022coll416:815"]/h4').text).must_equal 'Page 2'
    # Page 7 doesn't show up for this search result
    _(has_selector?(:xpath, '//*[@id="sidebar-p16022coll416:820"]/div/img')).must_equal false
    # Clear the search
    find(:xpath, '//*[@id="sidebar-pages"]/div/a').click
    # Page 7 should be back in the list now
    _(has_selector?(:xpath, '//*[@id="sidebar-p16022coll416:820"]/div/img')).must_equal true
  end
end
