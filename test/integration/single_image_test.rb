...
class SingleImageTest < ActiveSupport::TestCase
  ...
  it 'displays a clickable list of related items' do
    ...
    find(:xpath, '//*[@id="main"]/h1').text.must_equal('16th Century, Acapulco')
  end
  ...
  it 'provides a clickable iiif link' do
    ...
    JSON.parse(page.text)['@id'].must_equal 'https://cdm16022.contentdm.oclc.org/iiif/info/p16022coll251/4144/manifest.json'
  end
