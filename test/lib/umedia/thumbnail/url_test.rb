    ...
    class UrlTest < ActiveSupport::TestCase
      describe 'when an item is an image' do
        describe 'and we ask for the default CDM thumbnail' do
          it 'produces an cdm image thumbnail url' do
            ...
            _(url.to_s).must_equal 'imageurlhere'
            _(url.to_cdn_s).must_equal 'https://dkp5i0hinw9br.cloudfront.net/87b9bff439a69511f7e7e545478972916af0b257.png'
      ...
      describe 'when an item is an kaltura audio' do
        it 'produces a kaltura audio url' do
          ...
          _(url.to_s).must_equal 'audiothumburlhere'
          _(url.to_cdn_s).must_equal 'https://dkp5i0hinw9br.cloudfront.net/f8f199197f33329f008e253414d520a70b5066ff.png'
      ...
      describe 'when an item is an kaltura video' do
        it 'produces a kaltura video url' do
          ...
          _(url.to_s).must_equal 'videourlhere'
          _(url.to_cdn_s).must_equal 'https://dkp5i0hinw9br.cloudfront.net/d055b959ed1bcb485d02e042b695f2fd131bc0b7.png'
      ...
      describe 'when an item is an pdf' do
        it 'produces a pdf url' do
          ...
          _(url.to_s).must_equal 'pdfthumburlhere'
          _(url.to_cdn_s).must_equal 'https://dkp5i0hinw9br.cloudfront.net/5580c0ddfaa02a0c3581a5e9888e39eff4a259c9.png'
