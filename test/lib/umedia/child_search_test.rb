...
module Umedia
  class ChildSearchTest < ActiveSupport::TestCase
    it 'searches for children of a item' do
      ...
      solr.expect :get, {'highlighting' => 'highlighting here', 'response' => { 'docs' =>[{id: 'sdfsdf:sdf'}]} }, ["child_search", {:params=>{:q=>"", :"q.alt"=>"*:*", :sort=>"child_index asc", :hl=>"on", :fl=>"title, id, object, parent_id, child_viewer_types, viewer_type", :"hl.method"=>"unified", :fq=>["parent_id:\"9942\""], :rows=>2000}}]
